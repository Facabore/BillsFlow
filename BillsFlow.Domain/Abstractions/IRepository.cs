...
public interface IRepository<T> where T : class
{
    ...
    /// <summary>
    /// Convert query on a queryable
    /// </summary>
    /// <param name="T"></param>
    /// <returns></returns>
    IQueryable<T> GetQueryable(CancellationToken cancellation = default);
    /// <summary>  
    ...
    /// </summary>
    /// <param name=""></param>
    /// <returns> All entity without the filter</returns>
    Task<IEnumerable<T>> GetAllWithDeleteAsync(CancellationToken cancellationToken);
}